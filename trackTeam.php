...
if (isset($_POST['field_submit'])) {
    ...
    $query = "SELECT * FROM teams_changes";
              ...
              <table bordercolor="white" cellspacing="10" border="5">
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <th style="width:100px">Team Inserted</th>     
                    <th style="width:500px">Team Deleted</th>  
                    <th style="width:500px">Team Updated</th>          
                ...
                <tbody>
                  ...
                  <?php foreach ($result as $row) { ?>
                    <tr>
                      ...
                      <td><?php echo $row["team_inserted"]; ?></td>
                      <td><?php echo $row["team_deleted"]; ?></td>
                      <td><?php echo $row["team_updated"]; ?></td>
