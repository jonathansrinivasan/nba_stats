...
if (isset($_POST['f_submit'])) {
    ...
    $query = "INSERT INTO teams_main (LEAGUE_ID, ABBREVIATION, TEAM_NICKNAME, CITY, `OWNER`, GENERALMANAGER, HEADCOACH, DLEAGUEAFFILIATION) "
            . "VALUES (0, :_ABBREVIATION, :_TEAM_NICKNAME, :_CITY, :_OWNER, :_GENERALMANAGER, :_HEADCOACH, :_DLEAGUEAFFILIATION)";
...
<div class="box">
  ...
  <?php
    if (isset($_POST['f_submit'])) {
        if ($result) { 
    ?>
          Team was inserted successfully.
    <?php 
        } else { 
    ?>
          <h3> Sorry, there was an error. Team was not inserted. </h3>
    <?php 
        }
      } 
    ?>
